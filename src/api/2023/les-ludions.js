...
export default {
  ...
  methods: {
      ...
      return db
        ...
        .then(querySnapshot => {
          querySnapshot.forEach(event => {
            ...
            var storageRef = str.ref();
            var imagesRef = storageRef.child("/events2023");
      ...
      return db
        ...
        .then(querySnapshot => {
          querySnapshot.forEach(res => {
            ...
            db.collection("2023Reservations")
              .doc(res.id)
    ...
    async sendPigeon(pigeon) {
      ...
      return await db.collection("2023Pigeons").add(input);
    },
    async addDemande(demande, jour, label) {
      ...
      await db.collection("2023Pigeons").add(input);
      return await db
        .collection("2023Reservations")
        .doc(jour)
        .collection("Spectacles")
    ...
    async getBlogs() {
      ...
      if (!this.blogs || (this.blogs && !this.blogs.isLoading)) {
        ...
        let allBlogs = [];
        let blogs = await db.collection("2023Blog").get();
