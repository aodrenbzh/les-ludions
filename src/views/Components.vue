        ...
        <div class="container-fluid text-center">
          <div class="md-layout">
            <div class="md-layout-item">
              ...
              <md-button href="#/artistes" class="md-simple md-success md-lg"
        ...
        <div class="container">
          <div class="md-layout text-center">
            ...
            <div class="md-layout-item md-size-50 md-small-size-100 mx-auto">
              <md-button
                href="https://www.creative-tim.com/product/les-ludions"
                target="_blank"
          ...
          <div class="md-layout text-center">
            <div class="md-layout-item md-size-66 md-small-size-100 mx-auto">
              ...
              <h4>
                ...
                and
                <a
                  href="https://www.creative-tim.com/product/vue-les-ludions-pro?ref=utp-vmk-demos"
                  target="_blank"
...
export default {
  ...
  props: {
    image: {
      ...
      default: require("@/assets/img/carolles1.jpg")
    },
    leaf4: {
      type: String,
